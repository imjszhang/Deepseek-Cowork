...
```bash
# Install CLI tool globally (latest version: 0.1.7)
npm install -g deepseek-cowork@0.1.7
...
> **CLI Version**: `deepseek-cowork@0.1.7`
...
The project uses semantic versioning (SemVer). Current version: **V0.1.7**
