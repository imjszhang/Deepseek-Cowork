...
(function() {
  const locale = {
    ...
    wizard: {
      ...
      installClaudeMissing: 'Claude Code is not installed yet. Please follow the steps below',
      installNow: 'Install Now',
    ...
    notifications: {
      ...
      claudeCodeInstalled: 'Claude Code installed successfully',
      claudeCodeUpgraded: 'Claude Code upgraded successfully',
      claudeCodeInstallFailed: 'Failed to install Claude Code',
      claudeCodeUpgradeFailed: 'Failed to upgrade Claude Code',
      claudeCodeUpgradeUnsupported: 'Auto-upgrade is only supported for npm installations',
      npmRequiredForClaudeCode: 'npm is required to install or upgrade Claude Code automatically',
      claudeCodePermissionDenied: 'Installation failed due to insufficient permissions',
