...
(function() {
  const locale = {
    ...
    wizard: {
      ...
      installClaudeMissing: 'Claude Code 未安装，请按以下步骤安装',
      installNow: '立即安装',
      viewDocs: '查看官方文档',
      recheck: '重新检测',
    ...
    notifications: {
      ...
      claudeCodeInstalled: 'Claude Code 安装成功',
      claudeCodeUpgraded: 'Claude Code 升级成功',
      claudeCodeInstallFailed: 'Claude Code 安装失败',
      claudeCodeUpgradeFailed: 'Claude Code 升级失败',
      claudeCodeUpgradeUnsupported: '仅支持通过 npm 安装的 Claude Code 一键升级',
      npmRequiredForClaudeCode: '自动安装或升级 Claude Code 需要 npm',
      claudeCodePermissionDenied: '权限不足，无法完成安装或升级',
